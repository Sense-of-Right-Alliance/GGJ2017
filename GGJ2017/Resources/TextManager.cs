...
namespace GGJ2017.Resources
{
    public class TextManager
    {
        public static Dictionary<GameState, string> GameStateText = new Dictionary<GameState, string>()
        {
            ...
            { GameState.JerkSwappingOut, "Your turn has ended.  Please swap places with the friend and look away while they take their turn." },
            { GameState.FriendSwappingOut, "Your turn has ended.  Please swap places with the jerk and look away while they take their turn." },
